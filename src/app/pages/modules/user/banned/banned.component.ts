...
export class BannedComponent extends ModalForm<User> implements OnInit, OnChanges {
  ...
  setDateRange() {
    this.form.controls.startTime.setValue(moment(this.dateRange[0]).format('YYYY-MM-DD'));
    this.form.controls.endTime.setValue(moment(this.dateRange[1]).format('YYYY-MM-DD'));
  }
}
